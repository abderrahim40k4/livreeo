<template>
    <div class="bg-white-blue pt-16 pb-12">
      <div class="container mx-auto max-w-7xl">
        <div class="w-full flex">
          <div class="w-1/2">
            <div class="w-full flex flex-col">
              <div>
                <img src="../../assets/back-arraw.svg" class="h-10" alt="back">
              </div>
              <div class="flex flex-col pt-10">
                <h3 class="font-bold text-dark-blue text-xl pb-5">Adresse de livraison </h3>
                <form class="flex flex-col w-1/2 space-y-4">
                  <input type="text" placeholder="Adresse" class="py-4 px-6 rounded-full">
                  <input type="text" placeholder="Ville" class="py-4 px-6 rounded-full">
                  <input type="text" placeholder="Info complementaire" class="py-4 px-6 rounded-full">
                  <div class="pt-6">
                    <input type="button" value="Aller au paiement" class="bg-dark-blue text-white-color px-8 cursor-pointer rounded-full py-3">
                  </div>
                </form>
              </div>
            </div>
          ...
          <div class="w-1/2 flex flex-col items-center space-y-5">
            <div class="bg-white-color border-[1px] border-dark-blue w-[90%] md:w-3/4 lg:w-[70%] min-h-[350px] md:h-[420px] rounded-3xl pt-4 md:pt-8 pb-10">
              <h1 class="text-dark-blue font-bold text-2xl md:text-4xl lg:text-[40px] pb-3 md:pb-8 pl-5 md:pl-8">Panier</h1>
            ...
            <div class="bg-gradient-to-b from-[#FFFFFF] to-[#E5EBFF] text-dark-blue flex flex-col border-[1px] border-dark-blue w-[90%] md:w-3/4 lg:w-[70%] rounded-3xl px-8 py-5">
              <div>
              ...
              <div class="w-full flex items-center justify-between py-5">
                ...
                <div>
                  <p class="text-sm font-semibold">3027,00 MAD</p>
                </div>
              </div>
              ...
              <div class="w-full flex items-center justify-between pt-5">
                ...
                <div>
                  <p class="text-sm font-bold">3027,00 MAD</p>
                </div>
              </div>
            </div>
          </div>
